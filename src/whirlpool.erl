...
%%% @doc       Whirlpool gen_server server - handles primary interactions
%%%            with a started whirlpool instance, like checking in/out
...
%% API
-export([start_link/0, limit/0, unused/0, status/0, queue/0, enqueue/1, dequeue/1, checkout/0, checkin/1]).
